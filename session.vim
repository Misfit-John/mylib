...
set shortmess=aoO
badd +30 header/JZFlagManager.h
badd +0 Util/JZFlagManager.cpp
badd +14 ~/mylib/header/JZCommonDefine.h
args header/JZFlagManager.h Util/JZFlagManager.cpp
edit header/JZFlagManager.h
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 18 - ((4 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
18
